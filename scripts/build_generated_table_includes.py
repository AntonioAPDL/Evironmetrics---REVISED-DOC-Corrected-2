...
def main() -> None:
    ...
    gamma_block_lines = [
        ...
        r'\centering',
        r'\begin{threeparttable}',
        r'\caption{Posterior Medians and 95\% Credible Intervals for the Source-Specific Skewness Parameters $\gamma_j(\tau)$ at the Representative December 25, 2022 Cutoff}',
