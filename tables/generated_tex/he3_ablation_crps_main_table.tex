...
\caption{\textcolor{red}{Component-removal sensitivity analysis of the selected \texttt{exAL-M-T1} specification over the 28-day forecast horizon. Entries are mean forecast-window CRPS; lower values are better, and bold marks indicate the best reduced model value within each cutoff.}}
