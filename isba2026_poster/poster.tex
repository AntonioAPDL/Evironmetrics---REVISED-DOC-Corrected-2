...
\newcommand{\PosterLogoStrip}{%
  \begin{tcolorbox}[
    ...
    boxrule=0.55pt,
    arc=1.4mm,
    left=0.55cm,right=0.55cm,top=0.42cm,bottom=0.38cm,
    borderline north={1.1mm}{0pt}{ExalTeal}
  ]
    \begin{minipage}[c]{0.18\linewidth}
      {\FootFont\bfseries\color{PosterNavy}Source, forecast, and affiliation marks\par}
      \vspace{0.04cm}
      {\fontsize{15.5}{19}\selectfont\color{MutedGrey}Used as provenance cues, not endorsements.\par}
    \end{minipage}
    \hfill
    \LogoMark[1.30cm]{usgs_logo_green_cropped.png}{0.120\linewidth}{USGS}
    \hfill
    \LogoMark[1.16cm]{ecmwf_logo_2400w.png}{0.145\linewidth}{ECMWF}
    \hfill
    \LogoMark[1.28cm]{glofas_logo.png}{0.115\linewidth}{GloFAS}
    \hfill
    \LogoMark[1.30cm]{noaa_logo_1800px.png}{0.085\linewidth}{NOAA}
    \hfill
    \LogoMark[1.30cm]{nws_logo_1800px.png}{0.085\linewidth}{NWS}
    \hfill
    \LogoMark[1.32cm]{ucsc_uc_seal_1800px.png}{0.095\linewidth}{UCSC}
  \end{tcolorbox}%
}
...
\begin{HeroResult}
  ...
  {\SmallBodyFont
    ...
    \textbf{AL-M-T1} has the lowest 28-day CRPS. The evidence supports
    exAL-M-T1 as a strong reference model, not a universal winner.\par}
  \end{GoldCallout}
\end{HeroResult}
...
\begin{PosterItems}
  \item Within the frozen manuscript benchmark, the multivariate active-transfer
  ...
  \item Active discount/epsilon screening results are excluded until a future
  replacement is formally promoted through the article and response workflow.
\end{PosterItems}
...
\begin{minipage}[c]{0.77\linewidth}
  ...
  \textbf{Provenance.} Figures and numerical claims come from frozen
  manuscript-facing artifacts dated 2026-06-19. Core references:
  Yu and Moyeed (2001), Prado and West (2010), Yan et al. (2025), and revised
  article manifests. Active screening results are excluded unless formally
  promoted later.\par
  \vspace{0.16cm}
