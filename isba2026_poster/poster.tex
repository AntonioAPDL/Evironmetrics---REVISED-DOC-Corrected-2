...
\setlength{\MainBodyHeight}{80.0cm}
...
\newcommand{\SourceLogoRibbon}{%
  \begin{tcolorbox}[
    ...
    height=2.35cm,
    valign=center,
    left=0.38cm,right=0.38cm,top=0.24cm,bottom=0.22cm,
    borderline west={1.4mm}{0pt}{ExalTeal}
  ]
  \begin{minipage}[c]{0.30\linewidth}
    \centering
    \LogoGraphic[0.48cm]{usgs_logo_green_cropped.png}{0.92\linewidth}{USGS}\par
    \vspace{0.05cm}
    {\fontsize{15}{17}\selectfont\color{MutedGrey}observations\par}
  \end{minipage}
  \hfill
  \begin{minipage}[c]{0.30\linewidth}
    \centering
    \LogoGraphic[0.58cm]{glofas_logo.png}{0.92\linewidth}{GloFAS}\par
    \vspace{0.05cm}
    {\fontsize{15}{17}\selectfont\color{MutedGrey}28-day guidance\par}
  \end{minipage}
  \hfill
  \begin{minipage}[c]{0.30\linewidth}
    \centering
    \LogoGraphic[0.68cm]{nws_logo_1800px.png}{0.54\linewidth}{NWS}\par
    \vspace{0.05cm}
    {\fontsize{15}{17}\selectfont\color{MutedGrey}8-day guidance\par}
  \end{minipage}
  \end{tcolorbox}%
}
...
\newcommand{\PosterLogoStrip}{%
  ...
  \end{minipage}
  \hfill
  \LogoMark[0.95cm]{usgs_logo_green_cropped.png}{0.135\linewidth}{USGS}
  \hfill
  \LogoMark[0.86cm]{ecmwf_logo_2400w.png}{0.145\linewidth}{ECMWF}
  \hfill
  \LogoMark[1.10cm]{glofas_logo.png}{0.120\linewidth}{GloFAS}
  \hfill
  \LogoMark[1.08cm]{nws_logo_1800px.png}{0.075\linewidth}{NWS}
  \hfill
...
\PosterGraphic[14.3cm]{rolling_origin_timeline.pdf}{Rolling-origin validation timeline}
...
\PosterGraphic[15.4cm]{model_schematic.pdf}{Dynamic quantile synthesis schematic}
...
\begin{HeroResult}
  ...
  \vspace{0.26cm}
  \PosterGraphic[32.5cm]{crps_28d_poster.pdf}{Five-cutoff 28-day CRPS comparison}
...
\PosterGraphic[13.5cm]{crps_8d_nws_poster.pdf}{Eight-day NWS-horizon CRPS comparison}
