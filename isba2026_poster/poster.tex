...
\setlength{\MainBodyHeight}{77.4cm}
...
\newcommand{\SectionHead}[2]{%
  ...
  \vspace{0.13cm}
  {\color{ExalTeal}\rule{0.18\linewidth}{1.25pt}%
   \color{PanelLine}\rule{0.82\linewidth}{0.7pt}}\par
  \vspace{0.30cm}
}
...
\newcommand{\SourceLogoRibbon}{%
  \begin{tcolorbox}[
    ...
    height=3.92cm,
    valign=center,
    left=0.46cm,right=0.46cm,top=0.34cm,bottom=0.32cm,
    borderline west={1.4mm}{0pt}{ExalTeal}
  ]
  \begin{minipage}[c]{0.30\linewidth}
    \centering
    \LogoGraphic[0.86cm]{usgs_logo_green_cropped.png}{0.92\linewidth}{USGS}\par
    \vspace{0.08cm}
  ...
  \begin{minipage}[c]{0.30\linewidth}
    \centering
    \LogoGraphic[0.50cm]{ecmwf_logo_2400w.png}{0.94\linewidth}{ECMWF}\par
    \vspace{0.05cm}
    \LogoGraphic[0.74cm]{glofas_logo.png}{0.94\linewidth}{GloFAS}\par
    \vspace{0.07cm}
  ...
  \begin{minipage}[c]{0.30\linewidth}
    \centering
    \LogoGraphic[0.94cm]{noaa_logo_1800px.png}{0.42\linewidth}{NOAA}\hspace{0.10cm}%
    \LogoGraphic[0.96cm]{nws_logo_1800px.png}{0.42\linewidth}{NWS}\par
    \vspace{0.07cm}
...
\newcommand{\PosterLogoStrip}{%
  ...
  \end{minipage}
  \hfill
  \LogoMark[1.05cm]{usgs_logo_green_cropped.png}{0.120\linewidth}{USGS}
  \hfill
  \LogoMark[0.98cm]{ecmwf_logo_2400w.png}{0.125\linewidth}{ECMWF}
  \hfill
  \LogoMark[1.20cm]{glofas_logo.png}{0.105\linewidth}{GloFAS}
  \hfill
  \LogoMark[1.12cm]{noaa_logo_1800px.png}{0.068\linewidth}{NOAA}
  \hfill
  \LogoMark[1.16cm]{nws_logo_1800px.png}{0.064\linewidth}{NWS}
  \hfill
  \begin{minipage}[c]{0.150\linewidth}
    \RaggedLeft
...
\newcommand{\PosterHeader}{%
  ...
  \begin{minipage}[t]{0.225\textwidth}
    ...
    \begin{minipage}[t]{0.31\linewidth}
      \RaggedLeft
      \LogoGraphic[3.12cm]{ucsc_uc_seal_1800px.png}{3.12cm}{UCSC}
      \vspace{0.06cm}
      {\FootFont\bfseries\color{PosterNavy}UC Santa Cruz\par}
    \end{minipage}
    \vspace{0.30cm}
...
\PosterGraphic[19.6cm]{rolling_origin_timeline.pdf}{Rolling-origin validation timeline}
...
\PosterGraphic[21.0cm]{model_schematic.pdf}{Dynamic quantile synthesis schematic}
...
\PosterGraphic[18.2cm]{crps_8d_nws_poster.pdf}{Eight-day NWS-horizon CRPS comparison}
...
\PosterGraphic[23.6cm]{cutoff_2022_12_25_multivariate_synthesis_with_reference_ensembles.png}{Representative 2022-12-25 synthesis}
