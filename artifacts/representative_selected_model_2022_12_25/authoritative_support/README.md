...
This bundle contains compact posterior support artifacts and rendered figures for the representative `2022-12-25 exAL-M-T1` selected model. It is the full-history support bundle used for the dry/wet and 80-month interpretation diagnostics. It has not yet been regenerated from the `2026-06-23` clean HE2 authority; those refreshed clean artifacts are now used for the main 28-day CRPS table, representative synthesis panel, source-parameter summaries, covariate summaries, and cutoff-specific synthesis panels. Figure A1 is article-labeled as the 80-month seasonal component; its internal render metadata records the audited samplewise component-6-plus-trend construction and the dry/wet period overlays. The `analysis_figures/component_evolution/` subfolder is an analysis-only component gallery rendered from the same support CSVs; it is checksummed here but intentionally not registered as a manuscript figure family. It also includes the samplewise component-6-minus-trend diagnostic when the support summary provides that contract.
