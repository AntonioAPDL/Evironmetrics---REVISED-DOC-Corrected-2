...
|---|---|---|---|---|---|
| `Figures/README.md` | figure unaffected by corrected lineage | `unchanged_intentionally` | `n/a` | `n/a` | - |
...
| `Figures/mirror_manifest.csv` | figure unaffected by corrected lineage | `unchanged_intentionally` | `n/a` | `n/a` | - |
