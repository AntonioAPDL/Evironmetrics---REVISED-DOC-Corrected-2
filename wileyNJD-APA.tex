...
\While{\(k < k_{\max}\) and convergence criteria are not met}
    ...
    \Statex \hspace{\algorithmicindent} state, scale, and skewness changes are below their tolerances
\EndWhile
