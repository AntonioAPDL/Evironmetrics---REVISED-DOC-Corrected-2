...
- [x] Decide whether the historical-regime figures remain as a compact main-text block or move to supplement.
  - Source: structural blueprint Section 4
  - Decision: keep the dry/wet regime pair in the main text; keep the long-cycle seasonal figure in the selected-model interpretation section as a component diagnostic.
